...
namespace alby.pantheon.codegen.test
{
	...
	{
		protected void Populate٠Centre( bool insert, t.Centre obj )
		{
			if ( insert )
			{
				...
				obj.CentreCode = "@" ;
				obj.CentreName = "@" ;
				obj.CentreManagerName = "@" ;
				obj.UpdateUserCode = "@" ;
				obj.UpdateDateTime = new DateTime(1900,1,1) ;
				obj.SolicitorWebServiceGUID = obj1٠SolicitorWebService != null ? obj1٠SolicitorWebService.SolicitorWebServiceGUID : obj0٠SolicitorWebService.SolicitorWebServiceGUID ;
			}
			else // update
			{
				obj.CentreCode = "#" ;
