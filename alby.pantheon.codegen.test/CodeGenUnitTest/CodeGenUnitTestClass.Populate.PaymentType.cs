...
namespace alby.pantheon.codegen.test
{
	...
	{
		protected void Populate٠PaymentType( bool insert, t.PaymentType obj )
		{
			if ( insert )
			{
				obj.PaymentTypeID = toint( factory٠PaymentTypeFactory.GetNextIdˡ( _connection, t.PaymentType.column٠PaymentTypeID, true ).ToString() ) ;
				obj.PaymentTypeDescription = "@" ;
				obj.UpdateUserCode = "@" ;
