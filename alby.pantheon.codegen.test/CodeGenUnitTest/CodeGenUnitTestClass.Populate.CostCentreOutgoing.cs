...
namespace alby.pantheon.codegen.test
{
	...
	{
		protected void Populate٠CostCentreOutgoing( bool insert, t.CostCentreOutgoing obj )
		{
			if ( insert )
			{
				obj.CostCentreOutgoingID = toint( factory٠CostCentreOutgoingFactory.GetNextIdˡ( _connection, t.CostCentreOutgoing.column٠CostCentreOutgoingID, true ).ToString() ) ;
