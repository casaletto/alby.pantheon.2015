...
{
	public partial class LesseeFactory : acr.FactoryBase< Lessee, ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		static LesseeFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "Lessee" ;
			_selectˡ = "select * from {0} t " ;
			_insertˡ = "insert {0} ( [PartyID], [JobTitle], [UpdateUserCode], [UpdateDateTime] ) values ( @PartyID, @JobTitle, @UpdateUserCode, @UpdateDateTime ) " ;
			_insertIdentityˡ = "insert {0} ( [PartyID], [JobTitle], [UpdateUserCode], [UpdateDateTime] ) values ( @PartyID, @JobTitle, @UpdateUserCode, @UpdateDateTime ) " ;
			_updateˡ = "update {0} set [PartyID] = @PartyID, [JobTitle] = @JobTitle, [UpdateUserCode] = @UpdateUserCode, [UpdateDateTime] = @UpdateDateTime " ;
			_deleteˡ = "delete {0} " ;
			_whereLoadPKˡ = "where [PartyID] = @pk_PartyID " ;
			_whereSavePKˡ = "where [PartyID] = @pk_PartyID " ;
		}

		public Lessee Saveˡ( sds.SqlConnection connˡ, Lessee rowˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal, bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>();
			base.AddParameterˡ( parametersˡ, "@pk_PartyID", rowˡ.PrimaryKeyDictionaryˡ[ Lessee.column٠PartyID ] );
			base.AddParameterˡ( parametersˡ, "@PartyID", rowˡ.PartyID, sd.SqlDbType.Int );
			base.AddParameterˡ( parametersˡ, "@JobTitle", rowˡ.JobTitle, sd.SqlDbType.NText );
		...
		public scg.List<Lessee> Saveˡ( sds.SqlConnection connˡ, scg.List<Lessee> rowListˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal,  bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<Lessee> rowList2ˡ = new scg.List<Lessee>();
			foreach( Lessee rowˡ in rowListˡ )
			{
				Lessee row2ˡ = this.Saveˡ( connˡ, rowˡ, saveStrategyˡ, identityProvidedˡ, tranˡ ) ;
				if ( row2ˡ != null )	rowList2ˡ.Add( row2ˡ ) ;
			}
			return rowList2ˡ ;
		}

		public Lessee LoadByPrimaryKeyˡ
		(
		...
		public scg.List<Lessee> LoadByForeignKey٠From٠Party٠By٠PartyID
		(
			sds.SqlConnection connˡ,
			int? PartyID,
			int? topNˡ = null,
		...
		public scg.List<Lessee> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
