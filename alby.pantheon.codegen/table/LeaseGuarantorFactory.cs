...
{
	public partial class LeaseGuarantorFactory : acr.FactoryBase< LeaseGuarantor, ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		static LeaseGuarantorFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "LeaseGuarantor" ;
			_selectˡ = "select * from {0} t " ;
			_insertˡ = "insert {0} ( [PartyID], [LeaseID], [ACN], [DisplayOrder], [UpdateUserCode], [UpdateDateTime] ) values ( @PartyID, @LeaseID, @ACN, @DisplayOrder, @UpdateUserCode, @UpdateDateTime ) " ;
			_insertIdentityˡ = "insert {0} ( [PartyID], [LeaseID], [ACN], [DisplayOrder], [UpdateUserCode], [UpdateDateTime] ) values ( @PartyID, @LeaseID, @ACN, @DisplayOrder, @UpdateUserCode, @UpdateDateTime ) " ;
			_updateˡ = "update {0} set [PartyID] = @PartyID, [LeaseID] = @LeaseID, [ACN] = @ACN, [DisplayOrder] = @DisplayOrder, [UpdateUserCode] = @UpdateUserCode, [UpdateDateTime] = @UpdateDateTime " ;
			_deleteˡ = "delete {0} " ;
			_whereLoadPKˡ = "where [PartyID] = @pk_PartyID " ;
			_whereSavePKˡ = "where [PartyID] = @pk_PartyID " ;
		}

		public LeaseGuarantor Saveˡ( sds.SqlConnection connˡ, LeaseGuarantor rowˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal, bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>();
			base.AddParameterˡ( parametersˡ, "@pk_PartyID", rowˡ.PrimaryKeyDictionaryˡ[ LeaseGuarantor.column٠PartyID ] );
		...
		public scg.List<LeaseGuarantor> Saveˡ( sds.SqlConnection connˡ, scg.List<LeaseGuarantor> rowListˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal,  bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<LeaseGuarantor> rowList2ˡ = new scg.List<LeaseGuarantor>();
			foreach( LeaseGuarantor rowˡ in rowListˡ )
			{
				LeaseGuarantor row2ˡ = this.Saveˡ( connˡ, rowˡ, saveStrategyˡ, identityProvidedˡ, tranˡ ) ;
				if ( row2ˡ != null )	rowList2ˡ.Add( row2ˡ ) ;
			}
			return rowList2ˡ ;
		}

		public LeaseGuarantor LoadByPrimaryKeyˡ
		(
		...
		public scg.List<LeaseGuarantor> LoadByForeignKey٠From٠Lease٠By٠LeaseID
		(
			sds.SqlConnection connˡ,
			int? LeaseID,
			int? topNˡ = null,
		...
		public scg.List<LeaseGuarantor> LoadByForeignKey٠From٠Party٠By٠PartyID
		(
			sds.SqlConnection connˡ,
			int? PartyID,
			int? topNˡ = null,
		...
		public scg.List<LeaseGuarantor> Loadˡ
		(
			sds.SqlConnection connˡ,
			int? topNˡ = null,
			scg.List<acr.CodeGenOrderBy> orderByˡ = null,
		...
		public scg.List<LeaseGuarantor> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
