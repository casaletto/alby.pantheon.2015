...
{
	public partial class RDMFeeParam : acr.RowBase
	{
		public const string column٠RDMFeeParamID  = "RDMFeeParamID" ;
		public const string column٠TotalRDMFee  = "TotalRDMFee" ;
		...
		public int? RDMFeeParamID
		{
			get
			{
				return base.GetValueˡ<int?>( _dicˡ, column٠RDMFeeParamID ) ; 
			}
			set
			{
				base.SetValueˡ<int?>( _dicˡ, column٠RDMFeeParamID, value, ref _dirtyˡ ) ; 
			}
		}
		 
		public decimal? TotalRDMFee
		{
			get
			{
				return base.GetValueˡ<decimal?>( _dicˡ, column٠TotalRDMFee ) ; 
			}
			set
			{
				base.SetValueˡ<decimal?>( _dicˡ, column٠TotalRDMFee, value, ref _dirtyˡ ) ; 
			}
		}
		...
		public RDMFeeParam() : base()
		{
			base._dicˡ[ column٠RDMFeeParamID ] = null ;
			base._dicˡ[ column٠TotalRDMFee ] = null ;
			base._dicˡ[ column٠UpdateUserCode ] = null ;
			base._dicˡ[ column٠UpdateDateTime ] = null ;
			base._dicˡ[ column٠RowTimestamp ] = null ;
		 
			base._dicPKˡ[ column٠RDMFeeParamID ] = null ;
