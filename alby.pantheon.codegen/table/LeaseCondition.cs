...
namespace alby.pantheon.codegen.table
{
	public partial class LeaseCondition : acr.RowBase
	{
		...
		public const string column٠LeaseCondition_  = "LeaseCondition" ;
		...
		public string LeaseCondition_
		{
			get
			{
				return base.GetValueˡ<string>( _dicˡ, column٠LeaseCondition_ ) ; 
			}
			set
			{
				base.SetValueˡ<string>( _dicˡ, column٠LeaseCondition_, value, ref _dirtyˡ ) ; 
			}
		}
