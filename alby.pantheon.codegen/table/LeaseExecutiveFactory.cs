...
{
	public partial class LeaseExecutiveFactory : acr.FactoryBase< LeaseExecutive, ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		static LeaseExecutiveFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "LeaseExecutive" ;
			_selectˡ = "select * from {0} t " ;
			_insertˡ = "insert {0} ( [PartyID], [DisplayOrder], [UpdateUserCode], [UpdateDateTime], [DeletionIndicator] ) values ( @PartyID, @DisplayOrder, @UpdateUserCode, @UpdateDateTime, @DeletionIndicator ) " ;
			_insertIdentityˡ = "insert {0} ( [PartyID], [DisplayOrder], [UpdateUserCode], [UpdateDateTime], [DeletionIndicator] ) values ( @PartyID, @DisplayOrder, @UpdateUserCode, @UpdateDateTime, @DeletionIndicator ) " ;
			_updateˡ = "update {0} set [PartyID] = @PartyID, [DisplayOrder] = @DisplayOrder, [UpdateUserCode] = @UpdateUserCode, [UpdateDateTime] = @UpdateDateTime, [DeletionIndicator] = @DeletionIndicator " ;
			_deleteˡ = "delete {0} " ;
			_whereLoadPKˡ = "where [PartyID] = @pk_PartyID " ;
			_whereSavePKˡ = "where [PartyID] = @pk_PartyID " ;
		}

		public LeaseExecutive Saveˡ( sds.SqlConnection connˡ, LeaseExecutive rowˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal, bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>();
			base.AddParameterˡ( parametersˡ, "@pk_PartyID", rowˡ.PrimaryKeyDictionaryˡ[ LeaseExecutive.column٠PartyID ] );
		...
		public scg.List<LeaseExecutive> Saveˡ( sds.SqlConnection connˡ, scg.List<LeaseExecutive> rowListˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal,  bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<LeaseExecutive> rowList2ˡ = new scg.List<LeaseExecutive>();
			foreach( LeaseExecutive rowˡ in rowListˡ )
			{
				LeaseExecutive row2ˡ = this.Saveˡ( connˡ, rowˡ, saveStrategyˡ, identityProvidedˡ, tranˡ ) ;
				if ( row2ˡ != null )	rowList2ˡ.Add( row2ˡ ) ;
			}
			return rowList2ˡ ;
		}

		public LeaseExecutive LoadByPrimaryKeyˡ
		(
		...
		public scg.List<LeaseExecutive> LoadByForeignKey٠From٠Party٠By٠PartyID
		(
			sds.SqlConnection connˡ,
			int? PartyID,
			int? topNˡ = null,
		...
		public scg.List<LeaseExecutive> Loadˡ
		(
			sds.SqlConnection connˡ,
			int? topNˡ = null,
			scg.List<acr.CodeGenOrderBy> orderByˡ = null,
		...
		public scg.List<LeaseExecutive> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
