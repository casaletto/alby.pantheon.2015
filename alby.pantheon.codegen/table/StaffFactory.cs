...
{
	public partial class StaffFactory : acr.FactoryBase< Staff, ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		static StaffFactory() 
		{
		...
		public Staff Saveˡ( sds.SqlConnection connˡ, Staff rowˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal, bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>();
			base.AddParameterˡ( parametersˡ, "@pk_PartyID", rowˡ.PrimaryKeyDictionaryˡ[ Staff.column٠PartyID ] );
		...
		public scg.List<Staff> Saveˡ( sds.SqlConnection connˡ, scg.List<Staff> rowListˡ, acr.CodeGenSaveStrategy saveStrategyˡ = acr.CodeGenSaveStrategy.Normal,  bool identityProvidedˡ = false, sds.SqlTransaction tranˡ = null )
		{
			scg.List<Staff> rowList2ˡ = new scg.List<Staff>();
			foreach( Staff rowˡ in rowListˡ )
			{
				Staff row2ˡ = this.Saveˡ( connˡ, rowˡ, saveStrategyˡ, identityProvidedˡ, tranˡ ) ;
				if ( row2ˡ != null )	rowList2ˡ.Add( row2ˡ ) ;
			}
			return rowList2ˡ ;
		}

		public Staff LoadByPrimaryKeyˡ
		(
		...
		public scg.List<Staff> LoadByForeignKey٠From٠Party٠By٠PartyID
		(
			sds.SqlConnection connˡ,
			int? PartyID,
			int? topNˡ = null,
		...
		public scg.List<Staff> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
