...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreOutgoingArchiveGet
		(
			sds.SqlConnection connˡ, 
			int? CostCentreOutgoingID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreOutgoingArchiveGet٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreOutgoingArchiveGet" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreOutgoingArchiveGet٠rs1>( dsˡ, 1 ) ;
