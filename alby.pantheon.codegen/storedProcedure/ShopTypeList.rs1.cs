...
{
	public partial class ShopTypeList٠rs1 : acr.RowBase
	{
		public const string column٠ShopTypeID  = "ShopTypeID" ;
		public const string column٠ShopTypeDescription  = "ShopTypeDescription" ;
		...
		public string ShopTypeDescription
		{
			get
			{
				return base.GetValueˡ<string>( _dicˡ, column٠ShopTypeDescription ) ; 
			}
			set
			{
				base.SetValueˡ<string>( _dicˡ, column٠ShopTypeDescription, value, ref _dirtyˡ ) ; 
			}
		}
		...
		public ShopTypeList٠rs1() : base()
		{
			base._dicˡ[ column٠ShopTypeID ] = null ;
			base._dicˡ[ column٠ShopTypeDescription ] = null ;
