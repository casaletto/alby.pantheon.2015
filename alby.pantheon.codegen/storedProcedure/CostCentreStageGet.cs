...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreStageGet
		(
			sds.SqlConnection connˡ, 
			int? CostCentreStageID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreStageGet٠rs1> rsˡ1, 
			out scg.List<CostCentreStageGet٠rs2> rsˡ2, 
			out scg.List<CostCentreStageGet٠rs3> rsˡ3, 
			out scg.List<CostCentreStageGet٠rs4> rsˡ4, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreStageGet" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreStageGet٠rs1>( dsˡ, 1 ) ;
			rsˡ2 = base.ToRecordsetˡ<CostCentreStageGet٠rs2>( dsˡ, 2 ) ;
			rsˡ3 = base.ToRecordsetˡ<CostCentreStageGet٠rs3>( dsˡ, 3 ) ;
			rsˡ4 = base.ToRecordsetˡ<CostCentreStageGet٠rs4>( dsˡ, 4 ) ;
