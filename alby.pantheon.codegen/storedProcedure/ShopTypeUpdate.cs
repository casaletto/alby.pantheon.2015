...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int ShopTypeUpdate
		(
			sds.SqlConnection connˡ, 
			int? ShopTypeID, 
			string ShopTypeDescription, 
		...
		)
		{
			...
			const string spˡ = "ShopTypeUpdate" ; 
			...
			sds.SqlParameter paramˡShopTypeDescription = base.AddParameterˡ( parametersˡ, "@ShopTypeDescription", ShopTypeDescription, sd.SqlDbType.VarChar, true, 60, null, null ) ; 
