...
namespace alby.pantheon.codegen.storedProcedure
{
	public partial class StoredProcedureFactory : acr.StoredProcedureFactoryBase< ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		...
		)
		{
			...
			sds.SqlParameter paramˡChainCode = base.AddParameterˡ( parametersˡ, "@ChainCode", ChainCode, sd.SqlDbType.VarChar, true, 9, null, null ) ; 
			sds.SqlParameter paramˡChainDescription = base.AddParameterˡ( parametersˡ, "@ChainDescription", ChainDescription, sd.SqlDbType.VarChar, true, 60, null, null ) ; 
