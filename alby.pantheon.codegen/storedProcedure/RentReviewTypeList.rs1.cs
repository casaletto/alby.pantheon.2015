...
{
	public partial class RentReviewTypeList٠rs1 : acr.RowBase
	{
		public const string column٠RentReviewTypeID  = "RentReviewTypeID" ;
		public const string column٠RentReviewTypeDescription  = "RentReviewTypeDescription" ;
		...
		public string RentReviewTypeDescription
		{
			get
			{
				return base.GetValueˡ<string>( _dicˡ, column٠RentReviewTypeDescription ) ; 
			}
			set
			{
				base.SetValueˡ<string>( _dicˡ, column٠RentReviewTypeDescription, value, ref _dirtyˡ ) ; 
			}
		}
		...
		public RentReviewTypeList٠rs1() : base()
		{
			base._dicˡ[ column٠RentReviewTypeID ] = null ;
			base._dicˡ[ column٠RentReviewTypeDescription ] = null ;
