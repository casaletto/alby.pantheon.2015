...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreOutgoingArchiveList
		(
			sds.SqlConnection connˡ, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreOutgoingArchiveList٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreOutgoingArchiveList" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreOutgoingArchiveList٠rs1>( dsˡ, 1 ) ;
