...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int LeaseTypeUpdate
		(
			sds.SqlConnection connˡ, 
			int? LeaseTypeID, 
			string LeaseTypeDescription, 
		...
		)
		{
			...
			const string spˡ = "LeaseTypeUpdate" ; 
			...
			sds.SqlParameter paramˡLeaseTypeDescription = base.AddParameterˡ( parametersˡ, "@LeaseTypeDescription", LeaseTypeDescription, sd.SqlDbType.VarChar, true, 60, null, null ) ; 
