...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int ConsumerPriceIndexRentReviewGet
		(
			sds.SqlConnection connˡ, 
			int? RentReviewID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<ConsumerPriceIndexRentReviewGet٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "ConsumerPriceIndexRentReviewGet" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<ConsumerPriceIndexRentReviewGet٠rs1>( dsˡ, 1 ) ;
