...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreOutgoingList
		(
			sds.SqlConnection connˡ, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreOutgoingList٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreOutgoingList" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreOutgoingList٠rs1>( dsˡ, 1 ) ;
