...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int SalesCategoryUpdate
		(
			sds.SqlConnection connˡ, 
			int? SalesCategoryID, 
			string SalesCategoryCode, 
			string SalesCategoryDescription, 
		...
		)
		{
			...
			const string spˡ = "SalesCategoryUpdate" ; 
			...
			sds.SqlParameter paramˡSalesCategoryCode = base.AddParameterˡ( parametersˡ, "@SalesCategoryCode", SalesCategoryCode, sd.SqlDbType.VarChar, true, 9, null, null ) ; 
			sds.SqlParameter paramˡSalesCategoryDescription = base.AddParameterˡ( parametersˡ, "@SalesCategoryDescription", SalesCategoryDescription, sd.SqlDbType.VarChar, true, 60, null, null ) ; 
