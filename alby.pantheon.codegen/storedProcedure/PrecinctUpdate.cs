...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int PrecinctUpdate
		(
			sds.SqlConnection connˡ, 
			int? PrecinctID, 
			string PrecinctDescription, 
		...
		)
		{
			...
			const string spˡ = "PrecinctUpdate" ; 
			...
			sds.SqlParameter paramˡPrecinctDescription = base.AddParameterˡ( parametersˡ, "@PrecinctDescription", PrecinctDescription, sd.SqlDbType.VarChar, true, 60, null, null ) ; 
