...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int dt_getpropertiesbyid
		(
			sds.SqlConnection connˡ, 
			int? id, 
			string property, 
			out scg.List<dt_getpropertiesbyid٠rs1> rsˡ1, 
			out scg.List<dt_getpropertiesbyid٠rs2> rsˡ2, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "dt_getpropertiesbyid" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<dt_getpropertiesbyid٠rs1>( dsˡ, 1 ) ;
			rsˡ2 = base.ToRecordsetˡ<dt_getpropertiesbyid٠rs2>( dsˡ, 2 ) ;
