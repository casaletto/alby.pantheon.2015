...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreStageByCentre
		(
			sds.SqlConnection connˡ, 
			int? centreID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreStageByCentre٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreStageByCentre" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreStageByCentre٠rs1>( dsˡ, 1 ) ;
