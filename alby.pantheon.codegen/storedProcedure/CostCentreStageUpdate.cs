...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreStageUpdate
		(
		...
		)
		{
			...
			const string spˡ = "CostCentreStageUpdate" ; 
			...
			sds.SqlParameter paramˡCentreID = base.AddParameterˡ( parametersˡ, "@CentreID", CentreID, sd.SqlDbType.Int, true, null, 10, 0 ) ; 
			sds.SqlParameter paramˡCostCentreCode = base.AddParameterˡ( parametersˡ, "@CostCentreCode", CostCentreCode, sd.SqlDbType.VarChar, true, 9, null, null ) ; 
			sds.SqlParameter paramˡCostCentreDescription = base.AddParameterˡ( parametersˡ, "@CostCentreDescription", CostCentreDescription, sd.SqlDbType.NVarChar, true, 50, null, null ) ; 
