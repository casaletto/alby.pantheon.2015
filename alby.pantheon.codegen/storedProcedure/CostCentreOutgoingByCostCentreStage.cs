...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreOutgoingByCostCentreStage
		(
			sds.SqlConnection connˡ, 
			int? costCentreStageID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<CostCentreOutgoingByCostCentreStage٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CostCentreOutgoingByCostCentreStage" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CostCentreOutgoingByCostCentreStage٠rs1>( dsˡ, 1 ) ;
