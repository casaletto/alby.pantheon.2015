...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int ConsumerPriceIndexRentReviewUpdate
		(
			sds.SqlConnection connˡ, 
			int? RentReviewID, 
			string ConsumerPriceIndexDescription, 
			decimal? ConsumerPriceIndexIncrease, 
		...
		)
		{
			...
			const string spˡ = "ConsumerPriceIndexRentReviewUpdate" ; 
			...
			sds.SqlParameter paramˡConsumerPriceIndexDescription = base.AddParameterˡ( parametersˡ, "@ConsumerPriceIndexDescription", ConsumerPriceIndexDescription, sd.SqlDbType.NVarChar, true, 100, null, null ) ; 
			sds.SqlParameter paramˡConsumerPriceIndexIncrease = base.AddParameterˡ( parametersˡ, "@ConsumerPriceIndexIncrease", ConsumerPriceIndexIncrease, sd.SqlDbType.Decimal, true, null, 28, 10 ) ; 
