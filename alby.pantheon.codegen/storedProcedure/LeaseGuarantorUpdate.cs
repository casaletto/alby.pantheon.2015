...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int LeaseGuarantorUpdate
		(
		...
		)
		{
			...
			const string spˡ = "LeaseGuarantorUpdate" ; 
			...
			sds.SqlParameter paramˡDisplayOrder = base.AddParameterˡ( parametersˡ, "@DisplayOrder", DisplayOrder, sd.SqlDbType.Int, true, null, 10, 0 ) ; 
