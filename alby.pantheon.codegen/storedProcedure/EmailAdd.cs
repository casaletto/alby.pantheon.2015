...
namespace alby.pantheon.codegen.storedProcedure
{
	public partial class StoredProcedureFactory : acr.StoredProcedureFactoryBase< ns.database.pantheonDatabaseSingletonHelper, ns.database.pantheonDatabase >
	{
		...
		)
		{
			...
			sds.SqlParameter paramˡFromAddress = base.AddParameterˡ( parametersˡ, "@FromAddress", FromAddress, sd.SqlDbType.NVarChar, true, 50, null, null ) ; 
			sds.SqlParameter paramˡToAddress = base.AddParameterˡ( parametersˡ, "@ToAddress", ToAddress, sd.SqlDbType.NVarChar, true, 50, null, null ) ; 
			sds.SqlParameter paramˡSubject = base.AddParameterˡ( parametersˡ, "@Subject", Subject, sd.SqlDbType.NVarChar, true, 100, null, null ) ; 
			sds.SqlParameter paramˡBody = base.AddParameterˡ( parametersˡ, "@Body", Body, sd.SqlDbType.NVarChar, true, 100, null, null ) ; 
			sds.SqlParameter paramˡAttachments = base.AddParameterˡ( parametersˡ, "@Attachments", Attachments, sd.SqlDbType.NVarChar, true, 255, null, null ) ; 
