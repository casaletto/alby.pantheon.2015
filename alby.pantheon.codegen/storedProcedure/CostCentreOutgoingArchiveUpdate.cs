...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int CostCentreOutgoingArchiveUpdate
		(
		...
		)
		{
			...
			const string spˡ = "CostCentreOutgoingArchiveUpdate" ; 
			...
			sds.SqlParameter paramˡArchiveDate = base.AddParameterˡ( parametersˡ, "@ArchiveDate", ArchiveDate, sd.SqlDbType.DateTime, true, null, null, null ) ; 
