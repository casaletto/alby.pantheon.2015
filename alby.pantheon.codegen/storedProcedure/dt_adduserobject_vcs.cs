...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int dt_adduserobject_vcs
		(
		...
		)
		{
			...
			const string spˡ = "dt_adduserobject_vcs" ; 
			 
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>() ;
			sds.SqlParameter paramˡvchProperty = base.AddParameterˡ( parametersˡ, "@vchProperty", vchProperty, sd.SqlDbType.VarChar, true, 64, null, null ) ; 
