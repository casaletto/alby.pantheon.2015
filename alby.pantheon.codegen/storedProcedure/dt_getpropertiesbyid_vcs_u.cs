...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int dt_getpropertiesbyid_vcs_u
		(
		...
		)
		{
			...
			const string spˡ = "dt_getpropertiesbyid_vcs_u" ; 
			...
			sds.SqlParameter paramˡvalue = base.AddParameterˡ( parametersˡ, "@value", value, sd.SqlDbType.NVarChar, false, 255, null, null ) ; 
