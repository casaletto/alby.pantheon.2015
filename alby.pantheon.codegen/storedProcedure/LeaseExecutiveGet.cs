...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int LeaseExecutiveGet
		(
			sds.SqlConnection connˡ, 
			int? PartyID, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<LeaseExecutiveGet٠rs1> rsˡ1, 
			out scg.List<LeaseExecutiveGet٠rs2> rsˡ2, 
			out scg.List<LeaseExecutiveGet٠rs3> rsˡ3, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "LeaseExecutiveGet" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<LeaseExecutiveGet٠rs1>( dsˡ, 1 ) ;
			rsˡ2 = base.ToRecordsetˡ<LeaseExecutiveGet٠rs2>( dsˡ, 2 ) ;
			rsˡ3 = base.ToRecordsetˡ<LeaseExecutiveGet٠rs3>( dsˡ, 3 ) ;
