...
namespace alby.pantheon.codegen.storedProcedure
{
	...
	{
		public int SolicitorWebServiceList
		(
			sds.SqlConnection connˡ, 
			string UpdateUserCode, 
			DateTime? UpdateDateTime, 
			out scg.List<SolicitorWebServiceList٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "SolicitorWebServiceList" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<SolicitorWebServiceList٠rs1>( dsˡ, 1 ) ;
